...
Stosując narzędzia profilujące napisany algorytm ustalono, że najwięcej mocy obliczeniowej procesora jest zużywane podczas operacji krzyżowania dokonywanej na populacji. Z racji tego że krzyżowanie każdej pary osobników odbywa się niezależnie od pozostałych to miejsce wydało się naturalnym kandydatem aby dokonać próby zrównoleglenia.  Kolejnym miejscem które zrównoleglono było mutowanie populacji i tworzenie losowej populacji na podstawie mapy miast. Po dokonaniu zrównoleglenia nastąpiło około trzykrotne zwiększenie szybkości algorytmu.\\
Podjęto również próby zrównoleglenia operacji krzyżowania na poziomie osobnika, ale nie przyniosły one widocznych rezultatów, w związku z czym zrezygnowano z nich. 
